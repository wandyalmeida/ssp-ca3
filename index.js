...
router.post('/post/json', function(req, res){
    function appendJSON(obj){
        ...
        XMLtoJSON('menu.xml', function(err, result) {
            if (err) throw (err);
            result.menu.category[obj.sec_n].movie.push({'movie_name':obj.movie_name, 'type': obj.type, 'time': obj.time, 'Image': obj.image});
...
router.post('/post/delete', function (req,res) {
    function deleteJSON(obj) {
        ...
        XMLtoJSON('menu.xml', function(err, result){
            ...
            delete result.menu.category[obj.section].movie[obj.entree];
